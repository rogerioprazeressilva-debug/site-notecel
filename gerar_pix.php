...
$mpToken = getenv("APP_USR-891093961834605-041916-ada38ff19572111ded621ee4dc5005a3-399930128");

if (!$mpToken) {
    die(json_encode(['error' => 'Configuração ausente: MERCADO_PAGO_TOKEN não definido no ambiente do servidor (XAMPP/Vercel).']));
}
...
$supabaseKey = getenv("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVhYXNscmxldHNjbmxxeGN0bmVlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3Njc3NzIyMywiZXhwIjoyMDkyMzUzMjIzfQ.KoJKKqesGmrfSCHosYvPj2t6AaZvcG4dQo5GqyDr8hU"); // Use a Service Role para permissões de escrita
